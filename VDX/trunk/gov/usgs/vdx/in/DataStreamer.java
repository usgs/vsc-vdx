...
public class DataStreamer {
	...
	public void prepareStreaming() {
		...
		dataSource.createTranslation(stationObject.station, 
	...
	public void startStreaming() {
		...
		try {
			...
			Date lastDataTime = dataSource.getLastDataTime(stationObject.station);
				...
				if (!reconnect) {
					...
					if (msg != null) {
						try {
							...
							dataSource.insertData(stationObject.station, dl.t, dl.x, dl.y, dl.h, dl.b, dl.i, dl.g, dl.r);
