...
abstract public class Pipe extends Thread
{
    ...
    /** Creates a new stopped, alive Pipe and starts the Thread.  This does NOT start the polling
    ...
    /** Stops polling but doesn't kill the Pipe.  Polling can then be resumed.
     */
