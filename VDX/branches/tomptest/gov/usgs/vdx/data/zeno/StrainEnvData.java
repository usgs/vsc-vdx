...
/**
 * A class that holds strain environment data.  The data are stored in a 2-D matrix, the
 * first column is time (j2ksec), the second is hole temperature, the 
 * third is ambient air pressure, the fourth is data logger battery voltage, and 
...
public class StrainEnvData
{
	...
	/** Column number for ambient air pressure.
	 */
	 ...
	 * j2ksec, hole temp, preesure, voltage, and rainfall.
	 * @@param rows the number of rows of data
	 * @@param rs the data 
	 */
    public StrainEnvData(int rows, ResultSet rs)
    {
        try
        {
