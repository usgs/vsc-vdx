...
/**
 * Represent list of lightning strikes. Modeled after Hypo.HypocenterList
 *
 * @author Tom Parker
 */
public class StrokeList implements BinaryDataSet {
  ...
  public enum BinSize {
    ...
    /**
     * Convert string represenataion to seconds.
     */
  ...
  public void fromBinary(ByteBuffer bb) {
    ...
    for (int i = 0; i < rows; i++) {
      strokes.add(
          new Stroke(bb.getDouble(), bb.getInt(), bb.getDouble(), bb.getDouble(), bb.getInt(),
              bb.getDouble()));
    }
