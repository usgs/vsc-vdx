 ...
 * @author Dan Cervelli
 */
public class WwsWaveDataSource {} /*implements DataSource, SelectorProvider {
  ...
  public RequestResult getData(Map<String, String> params) {
    ...
    if (action != null && action.equals("channels")) {
      ...
      waveServer.connect();
      SampledWave sw = waveServer
          .getRawData(sta, cha, net, loc, Util.j2KToEW(t1), Util.j2KToEW(t2));
      if (sw != null) {
        sw.convertToJ2K();
      }
      waveServer.close();
