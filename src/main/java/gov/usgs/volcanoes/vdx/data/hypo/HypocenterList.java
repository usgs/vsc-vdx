...
public class HypocenterList implements BinaryDataSet {
  ...
  public enum BinSize {
    ...
    /**
     * Convert string representation to seconds.
     */
  ...
  public void fromBinary(ByteBuffer bb) {
    ...
    for (int i = 0; i < rows; i++) {
      Hypocenter hc = new Hypocenter(bb.getDouble(), (String) null, bb.getInt(), bb.getDouble(),
          bb.getDouble(), bb.getDouble(), bb.getDouble(),
          bb.getDouble(), bb.getDouble(), bb.getInt(), bb.getInt(), bb.getDouble(), bb.getDouble(),
          bb.getInt(),
          bb.getDouble(), bb.getDouble(), Character.toString((char) bb.getInt()),
          Character.toString((char) bb.getInt()));
      hypocenters.add(hc);
    }
  }
