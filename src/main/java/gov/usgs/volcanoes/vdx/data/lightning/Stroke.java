...
/**
 * A class that contains lightning strike information. Modeled after hypo.Hypocenter
 *
 * @author Tom Parker
 */
public class Stroke {
   ...
   * @param lat double
   * @param lon double
   * @param stationsDetected int
   * @param residual double
   */
  public Stroke(double j2ksec, int rid, double lat, double lon, int stationsDetected,
      double residual) {
    this.j2ksec = j2ksec;
    this.rid = rid;
    this.lat = lat;
