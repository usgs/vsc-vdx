...
public class SQLLightningDataSource extends SQLDataSource implements DataSource {
	...
	/**
	 * Getter for data. Search value of 'action' parameter and retrieve
	 * corresponding data.
	 * 
	 * @param params
	 *            command to execute, map of parameter-value pairs.
	 ...
	 *            north boundary
	 * @param maxrows
	 *            maximum nbr of rows returned
	 * @return list of hypocenter data
	 * @throws UtilException
	 */
	public StrokeList getStrokeData(int rid, double st, double et, double west, double east, double south, double north,
		...
		try {
			...
			double j2ksec, lat, lon, residual;
