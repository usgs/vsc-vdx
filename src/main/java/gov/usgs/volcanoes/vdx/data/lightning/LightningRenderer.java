...
/**
 * LightningRenderer is a class that render a list of lightning strikes in a variety
 * of different ways.
 *
...
//    		colorOption = "T";
     ...
     */
    public void createStrokeScaleRenderer(final double xStart, final double yStart)
    {
    	magnitudeScaleRenderer = new Renderer()
	    	{
	    		public void render(Graphics2D g)
	    		{
	                ...
	                g.drawString("# Stations Detected", (float)xStart - 80, (float)yStart);
	    			...
	    			for (StrokeCircle strokeCircle : StrokeCircle.values())
	                {
	                    ...
	                    g.translate(xStart - circle.x + offset, yStart + circle.y - 15);
