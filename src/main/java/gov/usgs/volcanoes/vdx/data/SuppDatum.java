...
public class SuppDatum {
  ...
  /**
   * Constructor String rep of SuppDatum is a CSV with: - strings each enclosed in quotes - all
   * MIN_VALUE characters will be translated to newlines - component order: sdid, st, et, cid, tid,
   * colid, rid, name, value, chName, typeName, colName, rkName, color.
   * 
   ...
   */
  public SuppDatum(Double st, Double et, String chName, String colName, String rkName,
      String typeName) {
    sdid = 0;
    cid = -1;
    this.chName = chName;
