...
/**
 * $Log: not supported by cvs2svn $ Revision 1.2  2007/01/31 06:42:26  tparker fix data pattern and
 * EOF detection
 *
 * @author Tom Parker
 */
public class ImportNwisArchive {
  ...
  public void importFile(String fn) {
    ...
    try {
      ...
      Pattern stationPattern = Pattern
          .compile("^.*//STATION AGENCY=\"(\\w*)\\s*\" NUMBER=\"(\\d*).*$");
  ...
  public static void main(String[] as) {
    ...
    if (args.contains("-h")) {
      System.err.println("java gov.usgs.volcanoes.vdx.data.generic.variable.ImportNwisArchive "
          + "[-c configFile] file ...");
      System.exit(-1);
    }
