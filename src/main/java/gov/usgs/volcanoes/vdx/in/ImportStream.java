...
public class ImportStream extends Import implements Importer {
  ...
  public void processConfigFile(String configFile) {
    ...
    for (int i = 0; i < dataSourceList.size(); i++) {
      ...
      channels = StringUtils
          .stringToString(dataSourceParams.getString("channels"), defaultChannels);
  ...
  public void process(String filename) {
    ...
    Date lastDataTime = sqlDataSource
        .defaultGetLastDataTime(channelCode, device.getNullfield(), device.getPollhist());
  ...
  /**
   * Output a help line to the command prompt.
   *
