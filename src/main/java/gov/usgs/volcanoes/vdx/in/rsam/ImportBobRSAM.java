...
public class ImportBobRSAM 
{
	...
	private void process(File f, String t)
	{
		...
		ImportBob ib = new ImportBob(params.getString("vdxConfig"), fileYear, params.getString("prefix"), t);	    		
	 ...
	 * Main method
	 * Syntax is:
	 * java gov.usgs.volcanoes.vdx.data.rsam.ImportBobRSAM [-c <configFile>] [-Y | -y <year> | -a]
	 * Options:
	...
	public static void main(String[] as)
	{
		...
		{
			System.err.println("java gov.usgs.volcanoes.vdx.data.rsam.ImportBobRSAM [-c <configFile>] [-Y | -y <year> | -a]");
